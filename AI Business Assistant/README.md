...
<p align="center">
  <img src="./Frontend/public/Logo.png" width="150" alt="Enterprise AI Assistant logo">
</p>
...
As capturas serão adicionadas conforme as próximas telas forem finalizadas.

| Dashboard | Chat | Configurações |
|---|---|---|
| `Docs/screenshots/dashboard.png` | `Docs/screenshots/chat.png` | `Docs/screenshots/settings.png` |
